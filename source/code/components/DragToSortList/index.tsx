...
function MovableSong({
    ...
    const top = useSharedValue(positions.value[id] * (SONG_HEIGHT + 10));
        ...
        (currentPosition, previousPosition) => {
            if (!isGestureActive.value)
                if (currentPosition !== previousPosition) {
                    if (!moving) {
                        top.value = withSpring(currentPosition * (SONG_HEIGHT + 10));
                    }
                }
        },
        [moving]
    ...
    const gestureHandler = useAnimatedGestureHandler({
        ...
        onActive(event) {
            ...
            top.value = withTiming(positionY - SONG_HEIGHT - headerHeight, {
                duration: 16,
            });

            const newPosition = clamp(
                Math.floor(positionY / (SONG_HEIGHT + 10)),
                0,
                songsCount - 1
            );
        ...
        onFinish() {
            top.value = positions.value[id] * (SONG_HEIGHT + 10);
    ...
    return (
        <Animated.View style={animatedStyle}>
            {/* <BlurView blurAmount={0} reducedTransparencyFallbackColor="white">
      <PanGestureHandler onGestureEvent={gestureHandler}>
          <Animated.View style={{ maxWidth: '80%' }}>
            ...
            {/* <BlurView blurAmount={moving ? 100 : 0} reducedTransparencyFallbackColor='white' style={{ top: 0, left: 0, right: 0, bottom: 0, position: 'absolute' }}>
...
export default function DragToSortList() {
