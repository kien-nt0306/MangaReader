...
const Item = ({
  ...
  const contentHeight = (Object.keys(positions.value).length / COL) * HEIGHT_SIZE;
  ...
  >({
    ...
    onActive: ({ translationX, translationY }, ctx) => {
      ...
      if (editing) {
        ...
        const upperBound = lowerBound + containerHeight - HEIGHT_SIZE;
  ...
  const style = useAnimatedStyle(() => {
    ...
    return {
      ...
      position: "absolute",
      top: HEIGHT_SIZE / 100 * 20 / 2,
      left: SIZE / 100 * 20 / 2,
      width: SIZE / 100 * 80,
      height: HEIGHT_SIZE / 100 * 80,
      zIndex,
      transform: [
